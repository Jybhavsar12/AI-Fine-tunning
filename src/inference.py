...
class ModelInference:
    ...
    def generate(
        ...
        repetition_penalty = repetition_penalty or inf_config.get(
            "repetition_penalty", 1.1
        )
        do_sample = (
            do_sample if do_sample is not None else inf_config.get("do_sample", True)
        )
...
def main():
    ...
    inference = ModelInference(
        model_path=args.model_path, base_model=args.base_model, config_path=args.config
    )

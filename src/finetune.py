...
class FineTuner:
    ...
    def prepare_datasets(self):
        ...
        if dataset_config['name'] == 'custom':
            ...
            train_dataset = preparator.load_from_huggingface(dataset_config['name'], split='train')
            eval_dataset = preparator.load_from_huggingface(dataset_config['name'], split='validation')

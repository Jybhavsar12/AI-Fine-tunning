...
def run_quick_finetune():
    ...
    print("="*60)
    print("\nNext steps:")
    print("1. Test your model with: python src/inference.py --model_path outputs/final_model")
    print("2. Evaluate your model with: python src/evaluate.py --model_path outputs/final_model --dataset data/eval.jsonl")
